    ...
    >
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-20 left-20 w-72 h-72 bg-primary-500/15 rounded-full blur-[100px]"
        />
        <motion.div
          animate={{ x: [0, -40, 50, 0], y: [0, 40, -50, 0] }}
          transition={{ duration: 25, repeat: Infinity }}
          className="absolute bottom-20 right-20 w-72 h-72 bg-secondary-500/15 rounded-full blur-[100px]"
        />
      </div>
      ...
      >
        <div className="glass-strong rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-surface-500 text-center mb-8">Sign in to your account to continue</p>
